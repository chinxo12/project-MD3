            ...
            <form action="">
                <div class="mainInput">
                    <div class="basicInfomation">
                        ...
                        <div class="input-group mb-3">
                            <button type="button"data-bs-toggle="modal" data-bs-target="#exampleModal"><span class="input-group-text" id="basic-addon1" >Chọn ngành hàng</span></button>
                            <input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group">
                            <span class="input-group-text">Mô tả sản phẩm</span>
                            <textarea name="txt_noidung" id="discription" class="form-control"
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div class="input-group-text">
                                    <input class="form-check-input mt-0" type="checkbox" value="S"
                                           aria-label="Checkbox for following text input">S
                                    <input class="form-check-input mt-0" type="checkbox" value="X"
                                           aria-label="Checkbox for following text input">X
                                    <input class="form-check-input mt-0" type="checkbox" value="L"
                                           aria-label="Checkbox for following text input">L
                                </div>
                            </div>
                            <div>
                                <h4>Color</h4>
                                <div class="input-group-text">
                                    <input class="form-check-input mt-0" type="checkbox" value="S"
                                           aria-label="Checkbox for following text input">red
                                    <input class="form-check-input mt-0" type="checkbox" value="X"
                                           aria-label="Checkbox for following text input">blue
                                    <input class="form-check-input mt-0" type="checkbox" value="L"
                                           aria-label="Checkbox for following text input">black
                                </div>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div>
                <div>
                    <div class="input-group mb-3">
                        <input  type="text" class="form-control" placeholder="Nhập vào tên danh mục " aria-label="Recipient's username" aria-describedby="button-addon2">
                ...
                <div>
                    <ul>
                        <li>
                            <button id="menFashion" >
                                Thời trang nam
                            </button>

                        </li>
                        <li><button>Thời trang nữ</button>

                        </li>
                        <li><button>Đồng hồ</button>
                        </li>
                        <li><button>Điện thoại</button> </li>
                        <li><button>Giày dép nam</button> </li>
                    </ul>
                </div>
            </div>
