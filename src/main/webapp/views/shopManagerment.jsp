            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item active">
                    <a class="sidebar-link" href="#">
                        <i class="align-middle" data-feather="grid"></i> <span class="align-middle">Quản lý đơn hàng</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="<%=request.getContextPath()%>/ProductServlet?action=getAllProduct">
                    ...
                    <div class="col-12 col-lg-8 col-xxl-9 d-flex">
                        <div class="card flex-fill">
                            ...
                            <table class="table table-hover my-0">
                                ...
                                <tr>
                                    <th>Tên sản phẩm</th>
                                    <th class="d-none d-xl-table-cell">Ngày đặt đơn</th>
                                    <th class="d-none d-xl-table-cell">Ngày hoàn thành</th>
                                    <th>Trạng thái</th>
                                    <th class="d-none d-md-table-cell">Người nhận hàng</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
