                ...
                <div class="mainInput">
                    <div class="basicInfomation">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="productName" placeholder="Nhập vào tên sản phẩm !" aria-label="Username"
                                   aria-describedby="basic-addon1">
                        </div>
...
<script>
    ...
    <%--$(function () {--%>
    <%--    $('#save_color_value').click(function () {--%>
    <%--        let val = [];--%>
    ...
    <%--        $.ajax({--%>
    <%--            type: 'GET',--%>
    <%--            url: '${pageContext.request.contextPath}/CatalogServlet?action=getSize&&size=' + size,--%>
    <%--            success: function (result) {--%>
    <%--                console.log("vaof dday khong????? size = ",result);--%>
    <%--            }--%>
    <%--        });--%>
    <%--        $.ajax({--%>
    <%--            type: 'GET',--%>
    <%--            url: '${pageContext.request.contextPath}/CatalogServlet?action=getColor&&color=' + color,--%>
    <%--            success: function (result) {--%>
    <%--                console.log("vaof dday khong????? color = ",result);--%>
    <%--            }--%>
    <%--        });--%>
    <%--    });--%>
    <%--});--%>
